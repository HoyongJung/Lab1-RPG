...
private:
    ...
    int maxEnergy;
public:
    Robot(string robotName, int robotMaxHP, int robotStrength, int robotSpeed, int robotMagic) : Fighter(robotName, robotMaxHP, robotStrength, robotSpeed, robotMagic){
    	maxEnergy = magic * ENERGY;
