...
private:
	int originSpeed;
public:
    Archer(string archerName, int archerMaxHP, int archerStrength, int archerSpeed, int archerMagic) : Fighter(archerName, archerMaxHP, archerStrength, archerSpeed, archerMagic){
    	originSpeed = speed;
    };
	~Archer() {}
