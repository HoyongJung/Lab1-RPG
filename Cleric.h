...
private:
    ...
    int currentMana;
public:
    Cleric(string clericName, int clericMaxHP, int clericStrength, int clericSpeed, int clericMagic) : Fighter(clericName, clericMaxHP, clericStrength, clericSpeed, clericMagic){
    	maxMana = magic * MANA;
    	currentMana = maxMana;
    };
	~Cleric() {}
